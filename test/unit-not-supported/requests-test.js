    ...
    describe("#write()", function () {
        it("should include keyspace from options", function () {
            ...
            const expectedBuffer = utils.allocBufferFromArray([
                ...
                0,
                0,
                0x7, // flags + stream id + opcode (0x7 = query)
                0,
                0,
                0,
                0x11, // length
                ...
                2,
                0x51,
                0x31, // query, length = 2, 'Q1'
                0,
                1,
                0,
                0,
                0,
                0x80, // consistency level + flags (0x80 = with keyspace)
                0,
                3,
                0x6b,
                0x73,
    ...
    describe("#write()", function () {
        it("should not include keyspace from options", function () {
            ...
            const expectedBuffer = utils.allocBufferFromArray([
                ...
                0,
                0,
                0xa, // flags + stream id + opcode (0xA = execute)
                0,
                0,
                0,
                0xe, // length
                ...
                2,
                0x51,
                0x31, // id length = 2 + id (Q1)
                0,
                2,
                0x52,
                0x31, // result id length = 2 + id (Q1)
                0,
                1,
                0,
                0,
    ...
    describe("#write()", function () {
        it("should include keyspace from options", function () {
            ...
            const expectedBuffer = utils.allocBufferFromArray([
                ...
                0,
                0,
                0x9, // flags + stream id + opcode (0x9 = prepare)
                0,
                0,
                0,
                0xf, // length
...
describe("BatchRequest", function () {
    ...
    it("should include keyspace from options", function () {
        ...
        const expectedBuffer = utils.allocBufferFromArray([
            ...
            0,
            0,
            0xd, // flags + stream id + opcode (0x7 = batch)
            0,
            0,
            0,
            0x20, // length
            ...
            0x31,
            0,
            0, // simple query, length = 2, 'Q1', 0 values
            0,
            0,
            0,
            0,
            ...
            0x32,
            0,
            0, // simple query, length = 2, 'Q2', 0 values
            0,
            1,
            0,
            0,
    ...
    describe("#write()", function () {
        ...
        it("should include NO_COMPACT in options if true", function () {
            ...
            const expectedBuffer = Buffer.concat([
                utils.allocBufferFromArray([
                    ...
                    0,
                    0,
                    1, // flags + stream id + opcode (1 = startup)
                    0,
                    0,
                    0,
                    40 + driverNameAndVersionBuffer.length, // length
                    0,
                    4, // map size
                ]),
        ...
        const expectedBufferWithNoCompact = Buffer.concat([
            utils.allocBufferFromArray([
                ...
                0,
                0,
                cqlVersionLength + driverNameAndVersionBuffer.length, // length
                0,
                3, // map size
            ]),
            getStringBuffer(startupOptions.cqlVersionKey),
        ...
        it("should include client id", () => {
            ...
            const clientValueBuffer = getStringBuffer(
                startupOptions.clientIdValue,
            );
            ...
            const expected = Buffer.concat([
                utils.allocBufferFromArray([
                    ...
                    0,
                    cqlVersionLength +
                        driverNameAndVersionBuffer.length +
                        clientKeyBuffer.length +
                        clientValueBuffer.length, // length
                    0,
                    4, // map size
                ]),
                getStringBuffer(startupOptions.cqlVersionKey),
            ...
            assert.deepEqual(
                new StartupRequest({ clientId }).write(encoder, 0),
                expected,
            );

            // ID as a string
            assert.deepEqual(
                new StartupRequest({ clientId: clientId.toString() }).write(
                    encoder,
                    0,
                ),
                expected,
        ...
        it("should include application name and version", () => {
            ...
            const expected = Buffer.concat([
                utils.allocBufferFromArray([
                    ...
                    cqlVersionLength +
                        driverNameAndVersionBuffer.length +
                        clientAndApplicationBuffer.length, // length
                    0,
                    6, // map size
                ]),
                getStringBuffer(startupOptions.cqlVersionKey),
    ...
    describe("#write()", () => {
        it("should have empty body", () => {
            const expectedBuffer = utils.allocBufferFromArray([
                ...
                0,
                0,
                5, // flags + stream id + opcode (5 = options)
                0,
                0,
                0,
                0, // body length 0
            ...
            assert.deepEqual(
                requests.options.write(encoder, 0),
                expectedBuffer,
            );
        });
    });
...
function getExecuteRequest(options, meta, params) {
    ...
    return new ExecuteRequest(
        "Q1",
        utils.allocBufferFromString("Q1"),
        params || [1, 2],
        execOptions,
        meta,
    );
