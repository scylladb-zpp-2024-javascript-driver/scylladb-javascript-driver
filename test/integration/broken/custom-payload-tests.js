...
describe("custom payload @SERVER_API", function () {
                ...
                [
                    ...
                    function executeBatch(next) {
                        ...
                        const queries = [
                            {
                                query: q,
                                params: [types.Uuid.random(), "text-batch1"],
                            },
                            {
                                query: q,
                                params: [types.Uuid.random(), "text-batch2"],
                            },
                        ];
                        client.batch(
                            queries,
    ...
    describe("using Client#batch(queries, { prepare: 1 }, callback)", function () {
        vit("2.2", "should encode and decode the payload", function (done) {
            ...
            const payload = {
                "key-batch-prep1":
                    utils.allocBufferFromString("val-batch-prep1"),
            };
            utils.series(
                [
                    client.connect.bind(client),
