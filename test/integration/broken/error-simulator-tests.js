...
describe("Client", function () {
    ...
    it(
        "should error with readTimeout with not enough received",
        errorResultTest(
            {
                result: "read_timeout",
                received: 1,
    ...
    it(
        "should error with readTimeout with no data present",
        errorResultTest(
            {
                result: "read_timeout",
                received: 2,
    ...
    it(
        "should error with readTimeout with repair timeout",
        errorResultTest(
            {
                result: "read_timeout",
                received: 2,
    ...
    it(
        "should error with SIMPLE writeTimeout",
        errorResultTest(
            {
    ...
    it(
        "should error with BATCH_LOG writeTimeout",
        errorResultTest(
            {
                result: "write_timeout",
                received: 0,
    ...
    it(
        "should error with writeFailure",
        errorResultTest(
            {
    ...
    it(
        "should error with functionFailure",
        errorResultTest(
            {
            ...
            (err, result) => {
                ...
                assert.ok(
                    err.message.indexOf("Could not execute function") !== -1,
                );
            },
        ),
    );
    it(
        "should error with alreadyExists (Table)",
        errorResultTest(
            {
    ...
    it(
        "should error with alreadyExists (Keyspace)",
        errorResultTest(
            {
                result: "already_exists",
    ...
    it(
        ...
        errorResultTest(
            ...
            (err, result) => {
                ...
                assert.strictEqual(
                    err.code,
                    types.responseErrorCodes.configError,
                );
    ...
    it(
        "should error with protocolError",
        errorResultTest(
            {
            ...
            (err, result) => {
                ...
                assert.strictEqual(
                    err.code,
                    types.responseErrorCodes.protocolError,
                );
    ...
    it(
        ...
        errorResultTest(
            ...
            (err, result) => {
                ...
                assert.strictEqual(
                    err.code,
                    types.responseErrorCodes.serverError,
                );
    ...
    it(
        "should error with unauthorized",
        errorResultTest(
            {
                result: "unauthorized",
            ...
            (err, result) => {
                ...
                assert.strictEqual(
                    err.code,
                    types.responseErrorCodes.unauthorized,
                );
        ...
        errorResultTest(
            ...
            (err, result) => {
                ...
                Object.keys(err.innerErrors).forEach((key) => {
                    ...
                    assert.strictEqual(
                        e.code,
                        types.responseErrorCodes.isBootstrapping,
                    );
        ...
        errorResultTest(
            ...
            (err, result) => {
                ...
                Object.keys(err.innerErrors).forEach((key) => {
                    ...
                    assert.strictEqual(
                        e.code,
                        types.responseErrorCodes.overloaded,
                    );
    ...
    it(
        "should error with truncateError",
        errorResultTest(
            {
            ...
            (err, result) => {
                ...
                Object.keys(err.innerErrors).forEach((key) => {
                    ...
                    assert.strictEqual(
                        e.code,
                        types.responseErrorCodes.truncateError,
                    );
                    assert.strictEqual(
                        e.message,
                        "Timeout while truncating table",
                    );
                });
            },
        ),
