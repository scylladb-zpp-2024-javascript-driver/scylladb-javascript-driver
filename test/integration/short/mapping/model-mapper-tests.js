    ...
    describe("#find()", () => {
        ...
        it("should support manual paging", () => {
            ...
            return Promise.all(
                ...
                .then(() =>
                    videoMapper.find({ userId }, null, { fetchSize: 3 }),
                )
                .then((result) => {
                ...
                .then((result) => {
                    ...
                    videosResult
                        ...
                        .sort()
                        .forEach((name, i) =>
                            assert.strictEqual(name, `video${i}`),
                        );
        ...
        vit("3.0", "should support query operators", () => {
            const testItems = [
                {
                    op: q.in_,
                    value: [new Date("2012-06-01 06:00:00Z")],
                    expected: 1,
                },
                {
                    op: q.gt,
                    value: new Date("2012-06-01 05:00:00Z"),
                    expected: 1,
                },
                {
                    op: q.gt,
                ...
                {
                    op: q.gt,
                    value: new Date("2012-06-01 07:00:00Z"),
                    expected: 0,
                },
                {
                    op: q.gte,
    ...
    describe("#insert()", () => {
        ...
        it("should use the correct table when no MappingOptions are specified", () => {
            ...
            return modelMapper
                .insert(doc)
                .then(() =>
                    mapperTestHelper.getVideoRows(client, { id: doc.videoid }),
                )
                .then((rows) => {
        ...
        it("should insert on some of the tables when those keys are not specified", () => {
            const doc = {
                ...
                description:
                    "This video will not be added to latest_videos table",
            };
            ...
            return videoMapper
                ...
                .then((rows) => {
                    ...
                    rows.slice(0, 2).forEach((row) =>
                        assertRowMatchesDoc(row, expectedDoc),
                    );
                });
        });
    ...
    describe("#update()", () => {
        ...
        it("should support conditional statements on a single table", () => {
            ...
            return mapperTestHelper
                .insertVideoRows(client, doc)
                .then(() =>
                    videoMapper.update(docUpdated, {
                        when: { name: "video cond 1" },
                    }),
                )
                .then((result) => {
                    helper.assertInstanceOf(result, Result);
        ...
        it("should adapt results of a LWT operation", () => {
            ...
            return client
                ...
                .then(() =>
                    userMapper.update(doc, { when: { firstName: "a" } }),
                )
                .then((result) => {
        ...
        it("should add new items to a set", () => {
            ...
            return client
                ...
                .then(() =>
                    mapperTestHelper.getVideoRows(client, { id: doc.id }),
                )
                .then((rows) => {
                    assert.strictEqual(rows.length, 1);
                    assert.deepStrictEqual(
