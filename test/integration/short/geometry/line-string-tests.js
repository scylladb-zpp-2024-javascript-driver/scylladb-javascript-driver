          ...
          client.execute("SELECT * FROM ks1.lines", function (err, result) {
            ...
            [
              ...
              [
                ...
                new LineString(new Point(-1.2, -100), new Point(0.99, 3)),
              ],
            ...
            [
              ...
              function (next) {
                client.execute(
                  insertQuery,
                  [id, udt],
                  { prepare: prepare, hints: [null, "udt<ks1.linet>"] },
                  function (err) {
                    assert.ifError(err);
                    client.execute(
                      selectQuery,
            ...
            [
              ...
              function (next) {
                client.execute(
                  insertQuery,
                  [id, map],
                  { prepare: prepare, hints: [null, types.dataTypes.map] },
                  function (err) {
                    assert.ifError(err);
                    client.execute(
                      selectQuery,
