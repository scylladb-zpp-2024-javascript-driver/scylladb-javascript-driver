...
vdescribe("dse-5.0", "Client @SERVER_API", function () {
    ...
    context("with classic graph engine", () => {
            ...
            it("should obtain DSE workload", function (done) {
                ...
                client.connect(function (err) {
                    ...
                    if (helper.isDseGreaterThan("5.1")) {
                        assert.deepEqual(host.workloads, [
                            "Cassandra",
                            "Graph",
                        ]);
                    } else {
        ...
        describe("#executeGraph()", function () {
            it(
                "should execute a simple graph query",
                wrapClient(function (client, done) {
                    client.executeGraph(
                        "g.V()",
                        null,
                        null,
            ...
            context("with modern schema", function () {
                ...
                before(
                    wrapClient((client, done) =>
                        graphTestHelper.createModernGraph(client, done),
                    ),
                );

                it(
                    "should retrieve graph vertices",
                    wrapClient(function (client, done) {
                ...
                it(
                    "should support multiple named parameters",
                    wrapClient(function (client, done) {
                        client.executeGraph(
                            "[a, b]",
                            { a: 10, b: 20 },
                ...
                it(
                    "should handle vertex id as parameter",
                    wrapClient(function (client, done) {
                        client.executeGraph(
                            ...
                            function (err, result) {
                                ...
                                const vertex = result.first();
                                assert.strictEqual(
                                    vertex.properties.name[0].value,
                                    "marko",
                                );
                                client.executeGraph(
                                    "g.V(vertex_id)",
                ...
                it(
                    "should handle edge id as parameter",
                    wrapClient(function (client, done) {
                        client.executeGraph(
                            "g.E().has('weight', weight)",
                            { weight: 0.2 },
                            null,
                            function (err, result) {
                                assert.ifError(err);
                ...
                it(
                    "should handle result object of mixed types",
                    wrapClient(function (client, done) {
                        const query =
                        ...
                        client.executeGraph(query, function (err, result) {
                            ...
                            results.forEach(function (result) {
                                ...
                                if (result.a === "lop") {
                                    ...
                                    assert.strictEqual(
                                        result.c[0].properties.name[0].value,
                                        "josh",
                                    );
                                }
                            });
                ...
                it(
                    "should retrieve path with labels",
                    wrapClient(function (client, done) {
                        ...
                        client.executeGraph(query, function (err, result) {
                            ...
                            results.forEach(function (path) {
                                ...
                                assert.strictEqual(
                                    marko.properties.name[0].value,
                                    "marko",
                                );
                                assert.strictEqual(
                                    marko.properties.age[0].value,
                                    29,
                                );
                                ...
                                assert.strictEqual(
                                    josh.properties.name[0].value,
                                    "josh",
                                );
                                assert.strictEqual(
                                    josh.properties.age[0].value,
                                    32,
                                );
                                ...
                                // software
                                if (
                                    software.properties.name[0].value === "lop"
                                ) {
                                    assert.strictEqual(
                                        created.properties.weight,
                                        0.4,
                                    );
                                } else {
                                    assert.strictEqual(
                                    ...
                                    assert.strictEqual(
                                        software.properties.name[0].value,
                                        "ripple",
                                    );
                                }
                                ...
                                assert.strictEqual(
                                    software.properties.lang[0].value,
                                    "java",
                                );
                            });
                            done();
                ...
                context("with bytecode-json as graph language", function () {
                    it(
                        "should retrieve Vertex instances",
                        wrapClient(function (client, done) {
                            ...
                            client.executeGraph(
                                ...
                                function (err, result) {
                                    ...
                                    arr.forEach(function (v) {
                                        ...
                                        assert.strictEqual(
                                            v.properties["age"].length,
                                            1,
                                        );
                                        helper.assertInstanceOf(
                                            v.properties["age"][0],
                                            graphModule.VertexProperty,
                                        );
                                        assert.strictEqual(
                                            typeof v.properties["age"][0].value,
                                            "number",
                                        );
                                    });
                                    done();
                    ...
                    it("should support object instances as traversals with query writers", async () => {
                        ...
                        assert.deepEqual(queryWriterFactory.getCall(0).args, [
                            graphProtocol.graphson2,
                        ]);
                        assert.strictEqual(queryWriter.callCount, 1);
                        assert.deepEqual(queryWriter.getCall(0).args, [
                            traversal,
                        ]);
                        await client.shutdown();
                    });
                    ...
                    it(
                        "should parse nested VertexProperties",
                        wrapClient(function (client, done) {
                            let vertex;
                            utils.series(
                                [
                                    ...
                                    function createVertex(next) {
                                        const query =
                                            "g.addV('graphson2_meta_v').property('graphson2_meta_prop', 'hello')";
                                        client.executeGraph(
                                            query,
                                            function (err, result) {
                                                assert.ifError(err);
                                    ...
                                    function extendProperty(next) {
                                        const query =
                                            "g.V(vId).next().property('graphson2_meta_prop').property('graphson2_sub_prop', 'hi')";
                                        client.executeGraph(
                                            query,
                                            { vId: vertex.id },
                                            function (err, result) {
                    ...
                    it(
                        "should retrieve Edge instances",
                        wrapClient(function (client, done) {
                            const query = JSON.stringify({
                                "@type": "g:Bytecode",
                                "@value": {
                    ...
                    it(
                        "should retrieve a Int64 scalar",
                        wrapClient(function (client, done) {
                            const query = JSON.stringify({
                                "@type": "g:Bytecode",
                                "@value": {
                    ...
                    it(
                        "should allow graph language to be set from the execution profile",
                        wrapClient(
                            function (client, done) {
                                ...
                                client.executeGraph(
                                    query,
                                    null,
                                    { executionProfile: "graph-profile1" },
                                    function (err, result) {
                                        assert.ifError(err);
                                        helper.assertInstanceOf(
                                            result,
                            ...
                            {
                                profiles: [
                                    new ExecutionProfile("graph-profile1", {
                                        graphOptions: {
                                            language: "bytecode-json",
                                        },
                                    }),
                                ],
                            },
            ...
            it(
                "should use list as a parameter",
                wrapClient(function (client, done) {
                    const characters = [
                        "Mario",
                        "Luigi",
                    ...
                    utils.series(
                        [
                            ...
                            function retrieveCharacters(seriesNext) {
                                client.executeGraph(
                                    "g.V().hasLabel('character').values('characterName')",
                                    function (err, result) {
                                        assert.ifError(err);
                                        assert.ok(result);
                                        const results = result.toArray();
                    ...
                    utils.series(
                        [
                            ...
                            function lookupVertex(next) {
                                ...
                                client.executeGraph(
                                    ...
                                    function (err, result) {
                                        ...
                                        assert.equal(
                                            vertex.properties.scientist_name[0]
                                                .value,
                                            name,
                                        );
                                        assert.equal(
                                            vertex.properties.field[0].value,
                                            field,
                                        );
                                        assert.equal(
                                            vertex.properties.year_born[0]
                                                .value,
                                            year,
                                        );
                            ...
                            function validateEdges(next) {
                                client.executeGraph(
                                    "g.V(vId).outE('had_citizenship').inV().values('country_name')",
                                    { vId: id },
                                    null,
                                    function (err, result) {
                                        assert.ok(result);
            ...
            it(
                "should be able to create and retrieve a multi-cardinality vertex property",
                wrapClient(function (client, done) {
                    let id;
                    utils.series(
                        [
                            ...
                            function createVertex(next) {
                                const query =
                                    "g.addV('multi_v').property('multi_prop', 'Hello').property('multi_prop', 'Sweet').property('multi_prop', 'World')";
                                client.executeGraph(
                                    query,
                                    function (err, result) {
                                        assert.ok(result);
                                        ...
                                        const vertex = result.first();
                                        const props =
                                            vertex.properties.multi_prop.map(
                                                function (v) {
                                                    return v.value;
                                                },
                                            );
            ...
            it(
                "should be able to create and retrieve vertex property with meta properties",
                wrapClient(function (client, done) {
                    let vertex;
                    utils.series(
                        [
                            ...
                            function createVertex(next) {
                                client.executeGraph(
                                    "g.addV('meta_v').property('meta_prop', 'hello')",
                                    function (err, result) {
                                        assert.ifError(err);
                                        assert.ok(result);
                                        assert.strictEqual(result.length, 1);
                            ...
                            function extendProperty(next) {
                                client.executeGraph(
                                    "g.V(vId).next().property('meta_prop').property('sub_prop', 'hi')",
                                    { vId: vertex.id },
                                    function (err, result) {
                                        assert.ifError(err);
                                        assert.ok(result);
                            ...
                            function extendProperty2(next) {
                                client.executeGraph(
                                    "g.V(vId).next().property('meta_prop').property('sub_prop2', 'hi2')",
                                    { vId: vertex.id },
                                    function (err, result) {
                                        assert.ifError(err);
                                        assert.ok(result);
                            ...
                            function validateVertex(next) {
                                client.executeGraph(
                                    ...
                                    function (err, result) {
                                        ...
                                        const nVertex = result.first();
                                        const meta_prop =
                                            nVertex.properties.meta_prop[0];
                                        assert.strictEqual(
                                            meta_prop.value,
                                            "hello",
                                        );
                                        assert.deepEqual(meta_prop.properties, {
                                            sub_prop: "hi",
                                            sub_prop2: "hi2",
                                        });
                                        next();
            ...
            it(
                "should handle multiple vertex creation queries simultaneously",
                wrapClient(function (client, done) {
                    const addQuery =
                        "g.addV('simu').property('username', username).property('uuid', uuid).property('number', number)";
                    ...
                    const flattenProperties = function (vertex) {
                        ...
                        return Object.keys(vertex.properties).reduce(function (
                            m,
                            k,
                        ) {
                                ...
                                client.executeGraph(
                                    ...
                                    function (err, result) {
                                        ...
                                        const results = result
                                            ...
                                            .sort(function (a, b) {
                                                return (
                                                    a.properties.number[0]
                                                        .value -
                                                    b.properties.number[0].value
                                                );
                                            });
            ...
            const pointType = is51
                ? "Point().withBounds(-40, -40, 40, 40)"
                : "Point()";
            const lineType = is51
                ? "Linestring().withGeoBounds()"
                : "Linestring()";
            const polygonType = is51
            ...
            const values = [
                ...
                [
                    "Duration()",
                    ["P2DT3H4M", "5 s", "6 seconds", "1 minute", "1 hour"],
                    ["PT51H4M", "PT5S", "PT6S", "PT1M", "PT1H"],
                ],
                ...
                [
                    "Inet()",
                    [
                        InetAddress.fromString("127.0.0.1"),
                        InetAddress.fromString("::1"),
                ...
                [
                    pointType,
                    [new Point(0, 1).toString(), new Point(-5, 20).toString()],
                ],
                [
                    lineType,
                    [
            ...
            if (is51) {
                values.push.apply(values, [
                    [
                        "Date()",
                        [
                            new types.LocalDate(2017, 2, 3),
                            new types.LocalDate(-5, 2, 8),
                        ],
                    ],
            ...
            values.forEach(function (args) {
                ...
                it(
                    util.format(
                        "should create and retrieve vertex with property of type %s",
                        propType,
                    ),
                    wrapClient(function (client, done) {
                        ...
                        const schemaQuery =
                            "" +
                            "schema.propertyKey(propertyName)." +
                            propType +
                            ".create()\n" +
                                ...
                                function addVertex(next) {
                                    utils.timesSeries(
                                        ...
                                        function (index, callback) {
                                            ...
                                            client.executeGraph(
                                                "g.addV(vertexLabel).property(propertyName, val)",
                                                params,
                                                null,
                                                function (err, result) {
                                                    assert.ifError(err);
                                                    validateVertexResult(
                                                        result,
                                                        expected[index],
                                                        vertexLabel,
                                                        propertyName,
    ...
    vdescribe("dse-6.8", "with core graph engine", () => {
        ...
        .property('tag', Text)
        .create()`;
            await client.executeGraph(createVertexLabel1Query, null, {
                graphName,
            });
            await client.executeGraph(createVertexLabel2Query, null, {
                graphName,
            });
            await client.executeGraph(createEdgeLabelQuery, null, {
                graphName,
            });
        });
        ...
        describe("#executeGraph", () => {
            ...
            it("should default to the correct graph results based on the execution profile", async () => {
                await client.executeGraph("g.V()", null, {
            ...
            it("should be able to add a vertex and traverse it", async () => {
                ...
                const selectTraversal = `g.V().hasLabel('label_test').has('id', ${id}).values('prop_text')`;
                const rs = await client.executeGraph(selectTraversal, null, {
                    executionProfile: "profile1",
                });
          ...
          .addE('created').from('first').to('second').property('tag', 'sample')`;
                ...
                let rs = await client.executeGraph(retrieveMapTraversal, null, {
                    executionProfile: "profile1",
                });
                const map = rs.first();
                ...
                rs = await client.executeGraph(retrieveEdgeTraversal, null, {
                    executionProfile: "profile1",
                });
                const edge = rs.first();
            ...
            it("should support named parameters", async () => {
                ...
                const rs = await client.executeGraph(
                    selectTraversal,
                    { myId: id },
                    { graphName },
                );
            ...
            it("should support BulkSet", async () => {
                ...
                const rs = await client.executeGraph(traversal, null, {
                    graphName,
                });
            ...
            it("should support Duration type", async () => {
                const id = schemaCounter++;
                const value = new types.Duration(
                    0,
                    3,
                    types.Long.fromString("12344553453012"),
                );
            ...
            it("should support elementMap() tokens", async () => {
                ...
                const rs = await client.executeGraph(traversalText, null, {
                    graphName,
                });
                const map = rs.first();
          ...
          schema.vertexLabel('label_complex').ifNotExists().partitionBy('id', Int)
            ...
            .create();`;
                    return client.executeGraph(createSchemaQuery, null, {
                        graphName,
                    });
                });
           ...
           (id, prop_udt1) VALUES (2, {address1: 'Apollo St.', zip_code: 12345 })`,
                ...
                it("should serialize tuples", async () => {
                    const id = schemaCounter++;
                    const insertTraversal = `g.addV('label_complex').property('id', myId)
              .property('prop_tuple1', tuple1).property('prop_tuple2', tuple2)`;

                    const tuple1 = new Tuple(asInt(1), "one");
                    const tuple2 = new Tuple(
                        Uuid.random(),
                        types.Long.fromString("1152921504606847000"),
                        "two",
                    );

                    await client.executeGraph(
                        insertTraversal,
                        { myId: id, tuple1, tuple2 },
                        { graphName },
                    );

                    const selectTraversal = `g.V().hasLabel('label_complex').has('id', myId).valueMap('prop_tuple1', 'prop_tuple2')`;
                    const rs = await client.executeGraph(
                        selectTraversal,
                        { myId: id },
                        { graphName },
                    ...
                    assert.deepEqual(result.get("prop_tuple1")[0].elements, [
                        1,
                        "one",
                    ]);
              ...
              .property('prop_udt1', udt1)`;
                    ...
                    const udtInfo = await client.metadata.getUdt(
                        graphName,
                        "address",
                    );
                    assert.ok(udtInfo);
                ...
                it("should serialize nested udts", async () => {
                    ...
                    const udtInfoAddress = await client.metadata.getUdt(
                        graphName,
                        "address",
                    );
                    const udtInfoContact = await client.metadata.getUdt(
                        graphName,
                        "contact_details",
                    );
                ...
                it("should support map values", async () => {
                    const id = schemaCounter++;
                    const insertTraversal = `g.addV('label_complex').property('id', myId).property('prop_map1', map1).property('prop_map2', map2)`;
                ...
                it("should support list values", async () => {
                    const id = schemaCounter++;
                    const insertTraversal = `g.addV('label_complex').property('id', myId).property('prop_list1', list1).property('prop_list2', list2)`;
...
function newInstance(options) {
    const opts = helper.getOptions(
        utils.extend(options || {}, { graphOptions: { name: "name1" } }),
    );
