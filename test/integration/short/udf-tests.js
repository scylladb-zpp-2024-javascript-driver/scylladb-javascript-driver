...
vdescribe("2.2", "Metadata @SERVER_API", function () {
    ...
    describe("#getFunction()", function () {
        ...
        vit(
            "dse-6.0",
            "should retrieve the metadata of a deterministic cql function",
            function (done) {
                const client = newInstance();
                utils.series(
                    [
        ...
        vit(
            "dse-6.0",
            "should retrieve the metadata of a monotonic cql function",
            function (done) {
                const client = newInstance();
                utils.series(
                    [
                        ...
                        function checkMeta(next) {
                            client.metadata.getFunction(
                                ...
                                function (err, func) {
                                    ...
                                    assert.deepEqual(func.monotonicOn, [
                                        "dividend",
                                        "divisor",
                                    ]);
                                    next();
        ...
        vit(
            "dse-6.0",
            "should retrieve the metadata of a deterministic and monotonic cql function",
            function (done) {
                const client = newInstance();
                utils.series(
                    [
        ...
        vit(
            "dse-6.0",
            "should retrieve the metadata of a partially monotonic cql function",
            function (done) {
                const client = newInstance();
                utils.series(
                    [
    ...
    describe("#getAggregate()", function () {
        ...
        vit(
            "dse-6.0",
            "should retrieve the metadata of a deterministic cql aggregate",
            function (done) {
                const client = newInstance();
                utils.series(
                    [
