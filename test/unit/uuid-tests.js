...
describe("Uuid", function () {
  ...
  describe("#toString()", function () {
    it("should convert to string representation", function () {
      ...
      val = new Uuid(
        utils.allocBufferFromString("a1b1ccddeeff00112233445566778899", "hex"),
      );
      assert.strictEqual(
        val.toString(),
      ...
      val = new Uuid(
        utils.allocBufferFromString("ffb1ccddeeff00112233445566778800", "hex"),
      );
      assert.strictEqual(
        val.toString(),
  ...
  describe("#equals", function () {
    it("should return true only when the values are equal", function () {
      ...
      const val2 = new Uuid(
        utils.allocBufferFromString("ffffffffffff00000000000000000000", "hex"),
      );
      const val3 = new Uuid(
        utils.allocBufferFromString("ffffffffffff00000000000000000001", "hex"),
      );
...
describe("TimeUuid", function () {
  ...
  describe("fromDate()", function () {
    ...
    it("should collide exactly at 10001 if date but not the ticks are specified", function () {
      ...
      //next should collide
      assert.strictEqual(
        values[TimeUuid.fromDate(date, null, "host01", "AA").toString()],
        true,
      );
    });
  ...
  describe("now()", function () {
    ...
    it("should reset the ticks portion of the TimeUuid to zero when the time progresses", function () {
      ...
      while (
        firstTimeUuid.getDate().getTime() === secondTimeUuid.getDate().getTime()
      ) {
