...
describe("DateRange", function () {
    const values = [
        ...
        [
            "0001-01-01",
            new DateRange(
                new DateRangeBound(getUtcDate(1, 1, 1), precision.day),
            ),
        ],
        [
            "-0001-01-01",
        ...
        [
            "-0009",
            new DateRange(
                new DateRangeBound(getUtcDate(-9, 1, 1), precision.year),
            ),
        ],
        [
            "0000",
            new DateRange(
                new DateRangeBound(getUtcDate(0, 1, 1), precision.year),
            ),
        ],
    ];
