      ...
      testQueries("find", [
        {
          ...
          docInfo: { limit: 100 },
          query:
            'SELECT * FROM ks1.table1 WHERE "id1" = ? AND "id2" >= ? LIMIT ?',
          params: ["value1", "e", 100],
        },
      ]));
      ...
      testQueries("find", [
        {
          ...
          query:
            'SELECT "name", "description", "location_type" FROM ks1.table1 WHERE "id1" = ? AND "id2" >= ?',
          params: ["value1", "e"],
        },
      ]));
    ...
    it("should support relational operators, orderBy, limit and fields", () =>
      testQueries("find", [
        ...
        },
        {
          ...
          query:
            'SELECT * FROM ks1.table1 WHERE "id1" = ? AND "id2" >= ? AND "id2" >= ? AND "id2" < ?',
          params: ["value1", "a", "e", "z"],
        },
      ]));
      ...
      testQueries("findAll", [
        {
          docInfo: { fields: ["name", "description", "locationType"] },
          query:
            'SELECT "name", "description", "location_type" FROM ks1.table1',
          params: [],
        },
      ]));
  });
