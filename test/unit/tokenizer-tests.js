    ...
    describe("#getBlock()", function () {
        it("should return expected results", function () {
            ...
            [
                ...
                assert.ok(
                    result.equals(MutableLong.fromBits(item[1], item[2])),
                );
            });
        });
    });
    describe("#hash()", function () {
        it("should hash the according results", function () {
            ...
            [
                ...
                [
                    [
                        0, 1, 2, 3, 255, 255, 255, 255, 255, 255, 255, 255, 255,
                        255, 255, 255,
                    ],
                    "6463632673159404390",
                ],
    ...
    describe("#hash", function () {
        it("should return expected results", function () {
            [
                ...
                [
                    utils.allocBufferFromString("fffafa000102030405fe", "hex"),
                    "93979376327542758013347018124903879310",
                ],
                [
                    utils.allocBufferFromString("f000ee0000", "hex"),
                    "155172302213453714586395175393246848871",
                ],
            ].forEach(function (item) {
        ...
        it("should return the Integer representation", function () {
            ...
            assert.ok(
                val
                    .getValue()
                    .equals(
                        types.Integer.fromString(
                            "141904934057871337334287797400233978956",
                        ),
                    ),
            );
        });
