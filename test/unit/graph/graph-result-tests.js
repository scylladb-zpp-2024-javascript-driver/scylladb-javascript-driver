      ...
      result: {
        ...
        properties: {
          name: [
            {
              id: {
                local_id: "00000000-0000-8007-0000-000000000000",
                "~type": "name",
                out_vertex: {
                  member_id: 0,
                  community_id: 586910,
          ...
          age: [
            {
              id: {
                local_id: "00000000-0000-8008-0000-000000000000",
                "~type": "age",
                out_vertex: {
                  member_id: 0,
                  community_id: 586910,
    ...
    gremlin: JSON.stringify({
      result: {
        id: {
          ...
          local_id: "4e78f871-c5c8-11e5-a449-130aecf8e504",
          in_vertex: {
            member_id: 0,
            community_id: 680148,
            "~label": "vertex",
...
describe("GraphResultSet", function () {
  ...
  describe("#values()", function () {
    ...
    it("should parse bulked results", function () {
      ...
      assert.deepEqual(utils.iteratorToArray(result1.values()), [
        "a",
        "b",
        "b",
        "c",
      ...
      assert.deepEqual(utils.iteratorToArray(result2.values()), [
        "a",
        "a",
        "a",
        "b",
