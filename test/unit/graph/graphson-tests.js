    ...
    describe("#read()", function () {
        ...
        (function defineObjectTest() {
            [
                ...
                [
                    "gx:BigInteger",
                    types.Integer,
                    types.Integer.fromString("99901"),
                ],
                [
                    "gx:InetAddress",
                    types.InetAddress,
                ...
                [
                    "dse:LineString",
                    geometry.LineString,
                    geometry.LineString.fromString(
        ...
        it("should read Vertex with nested properties", function () {
            ...
            helper.assertInstanceOf(
                result.properties["name"][0].id,
                types.Long,
            );
            helper.assertInstanceOf(result.properties["age"][0].id, types.Long);
            assert.ok(
                result.properties["age"][0].id.equals(
                    types.Long.fromString("1"),
                ),
            );
