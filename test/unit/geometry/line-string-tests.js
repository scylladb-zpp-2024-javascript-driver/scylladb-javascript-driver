        ...
        it("should create an instance from WKB", function () {
            [
                ...
                [
                    ...
                    [
                        new Point(658, 8.1234567),
                        new Point(1, 3),
                        new Point(-1, 111),
                    ],
                ],
            ].forEach(function (item) {
                const line = LineString.fromBuffer(
        ...
        it("should return WKT of the object", function () {
            [
                ...
                [
                    ...
                    "LINESTRING (658 8.1234567, 1 3, -1 111)",
                ],
            ].forEach(function (item) {
    ...
    describe("#fromString()", function () {
        it("should parse WKT representation", function () {
            [
                ...
                [
                    "LINESTRING (10 20, 30 40, -50.1 -60.1)",
                    [10, 20, 30, 40, -50.1, -60.1],
                ],
            ].forEach(function (item) {
