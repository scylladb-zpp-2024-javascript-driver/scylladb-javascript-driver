...
describe("Polygon", function () {
  describe("constructor", function () {
    ...
    it("should set #rings property", function () {
      [
        ...
        assert.strictEqual(
          JSON.stringify(polygon.rings[0]),
          JSON.stringify(ring),
        );
      });
    });
  ...
  describe("fromBuffer()", function () {
    it("should create an instance from WKB", function () {
      [
        ...
        const polygon = Polygon.fromBuffer(
          utils.allocBufferFromString(item[0], "hex"),
        );
        assert.strictEqual(polygon.rings.length, 1);
  ...
  describe("#fromString()", function () {
    it("should parse WKT representation", function () {
      [
        [
          "POLYGON ((10 20, 30 40, 30 -40, 10 20))",
          [[10, 20, 30, 40, 30, -40, 10, 20]],
        ],
        [
          "POLYGON((11.9 20, 30 40, 30 -40, 11.9 20))",
          [[11.9, 20, 30, 40, 30, -40, 11.9, 20]],
        ],
        [
          "POLYGON ((35 10, 45 45, 15 40, 10 20, 35 10), (20 30.1, 35 35, 30.1 20, 20 30.1))",
          [
            [35, 10, 45, 45, 15, 40, 10, 20, 35, 10],
            [20, 30.1, 35, 35, 30.1, 20, 20, 30.1],
          ],
        ],
      ].forEach(function (item) {
