  ...
  describe("#encode() and #decode()", function () {
    ...
    it("should encode/decode InetAddress/Buffer as inet", function () {
      ...
      val1 = new InetAddress(
        utils.allocBufferFromString("00000000000100112233445500aa00bb", "hex"),
      );
    ...
    it("should decode uuids into Uuid", function () {
      ...
      const decoded2 = typeEncoder.decode(types.Uuid.random().getBuffer(), {
        code: dataTypes.uuid,
      });
    ...
    it("should decode timeuuids into TimeUuid", function () {
      ...
      assert.strictEqual(uuid.toString(), decoded.toString());
      assert.ok(uuid.equals(decoded));
      const decoded2 = typeEncoder.decode(types.TimeUuid.now().getBuffer(), {
        code: dataTypes.timeuuid,
      });
      assert.ok(!decoded.equals(decoded2));
    });
    ...
    [2, 3].forEach(function (version) {
      ...
      it(
        util.format("should encode and decode maps for protocol v%d", version),
        function () {
          ...
          let decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.text }, { code: dataTypes.text }],
          });
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.text }, { code: dataTypes.double }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.uuid }, { code: dataTypes.double }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          //full info string
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.text }, { code: dataTypes.int }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          //full info typeInfo
      ...
      it(
        ...
        function () {
          ...
          let encoded = encoder.encode(value, {
            code: dataTypes.map,
            info: [{ code: dataTypes.timestamp }, { code: dataTypes.text }],
          });
          let decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.timestamp }, { code: dataTypes.text }],
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.bigint }, { code: dataTypes.text }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.uuid }, { code: dataTypes.text }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.timeuuid }, { code: dataTypes.text }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.varint }, { code: dataTypes.text }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.decimal }, { code: dataTypes.text }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.inet }, { code: dataTypes.text }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.time }, { code: dataTypes.text }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.date }, { code: dataTypes.text }],
          });
          assert.strictEqual(util.inspect(decoded), util.inspect(value));
        },
      );
      ...
      it(
        ...
        function () {
          const value = [
            1.1122000217437744, 2.212209939956665, 3.3999900817871094,
            4.412120819091797, -1000, 1,
          ];
          const encoded = encoder.encode(value, {
            code: dataTypes.list,
      ...
      it(
        ...
        function () {
          ...
          decoded = encoder.decode(encoded, {
            code: dataTypes.map,
            info: [{ code: dataTypes.timestamp }, { code: dataTypes.int }],
          });
          assert.strictEqual(getValues(decoded), getValues(m));
        },
      );
    ...
    it("should fail to encode if full type provided and input vector fails to match dimensions of type", function () {
      ...
      const typeName =
        "org.apache.cassandra.db.marshal.VectorType(org.apache.cassandra.db.marshal.FloatType,3)";
      assert.throws(function () {
        encoder.encode(refVal, { code: dataTypes.custom, info: typeName });
      }, TypeError);
    });
  ...
  describe("#encode()", function () {
    ...
    it("should decode 0-length map values of unsupported types into null values", function () {
      ...
      [2, 3].forEach((v) => {
        ...
        utils
          ...
          .filter(
            (t) => typeof t === "number" && !zeroLengthTypesSupported.has(t),
          )
          .forEach((t) => {
            const type = {
              code: types.dataTypes.map,
    ...
    it("should decode empty buffers as nulls for most types", () => {
      ...
      utils
        ...
        .forEach((code) =>
          assert.strictEqual(encoder.decode(emptyBuffer, { code }), null),
        );
    });
    ...
    it("should decode empty buffers as empty strings", () => {
      ...
      [dataTypes.text, dataTypes.ascii, dataTypes.varchar].forEach((code) =>
        assert.strictEqual(encoder.decode(emptyBuffer, { code }), ""),
      );
    });
    ...
    it("should decode null map values", function () {
      ...
      const value = encoder.decode(buffer, {
        code: types.dataTypes.map,
        info: [{ code: types.dataTypes.text }, { code: types.dataTypes.text }],
      });
      assert.ok(value);
