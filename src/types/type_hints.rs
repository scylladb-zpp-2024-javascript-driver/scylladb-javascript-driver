...
// When converting from JS object, it the field is not provided (ex: {code: 3})
// Then info field becomes None.
// When the field is set to null (ex: {code: 3, info: null})
// THen info field becomes Some(None).
// For this reason we need to have nested option in this object.
