...
use crate::errors::{
    ConvertedResult, IntoConvertedError, JsResult, js_error, with_custom_error_async,
...
impl SessionWrapper {
    ...
    pub async fn query_unpaged_encoded(
        ...
        with_custom_error_async(async || {
            ...
            let query_result = self
                ...
                .await?;
            QueryResultWrapper::from_query(query_result).into_converted_error()
        })
        .await
    }
    ...
    pub async fn batch_encoded(
        ...
        with_custom_error_async(async || {
            QueryResultWrapper::from_query(self.inner.batch(&batch.inner, params).await?)
                .into_converted_error()
        })
        .await
    }
