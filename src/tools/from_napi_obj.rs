/// This macro crates an struct with a defined list of field,
...
/// This struct implements a FromNapiValue,
...
/// ```
///
/// That can be passed from JS with the following Object:
/// ```js
/// {someField: false}
/// ```
///
...
/// ```
#[macro_export]
macro_rules! create_serializable_object {
    ($struct_name: ident, $({$field_name:ident, $field_type:ty}),*) => {
        ...
        impl FromNapiValue for $struct_name {
            ...
            unsafe fn from_napi_value(
                ...
                Ok($struct_name {
                    $(
                        $field_name: o.get::<$field_type>(stringify!($field_name).to_case(Case::Camel).as_str())?,
                    )*
                })
            }
        }
