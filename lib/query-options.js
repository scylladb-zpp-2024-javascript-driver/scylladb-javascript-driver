...
function queryOptionsIntoWrapper(options) {
    ...
    wrapper.autoPage = options.autoPage;
    wrapper.captureStackTrace = options.captureStackTrace;
    wrapper.consistency = options.consistency;
    wrapper.counter = options.counter;
    wrapper.fetchSize = options.fetchSize;
    wrapper.isIdempotent = options.idempotent;
    wrapper.keyspace = options.keyspace;
    wrapper.logged = options.logged;
    wrapper.prepare = options.prepare;
    wrapper.readTimeout = options.readTimeout;
    wrapper.routingIndexes = options.routingIndexes;
    wrapper.routingNames = options.routingNames;
    wrapper.serialConsistency = options.serialConsistency;
    wrapper.timestamp = options.timestamp;
