...
class ExecutionOptions {
    ...
    /**
     * Is this object final - meaning all session options are applied
     * @type {boolean}
     * @package
     */
    final;
    ...
    /**
     * Creates rust options wrapper.
     * Goal of this function is to reduced wrapping the same options multiple times.
     * @package
     */
    wrapOptions() {
        this.final = true;
