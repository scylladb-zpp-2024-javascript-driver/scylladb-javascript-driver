...
function Element(id, label) {
  throw new ReferenceError(
    `This class (Element) is not supported by our driver`,
  );
}
...
function Vertex(id, label, properties) {
  throw new ReferenceError(
    `This class (Vertex) is not supported by our driver`,
  );
}
...
function VertexProperty(id, label, value, properties) {
  throw new ReferenceError(
    `This class (VertexProperty) is not supported by our driver`,
  );
}
...
function Property(key, value) {
  throw new ReferenceError(
    `This class (Property) is not supported by our driver`,
  );
}
