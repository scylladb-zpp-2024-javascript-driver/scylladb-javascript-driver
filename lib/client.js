...
class Client extends events.EventEmitter {
    ...
    constructor(options) {
         ...
         * @type {Encoder}
         */
        this._encoder = new Encoder(0x04, this.options.encoding);
    }
    ...
    async rustyExecute(query, params, execOptions) {
        ...
        if (execOptions.isPrepared()) {
            ...
            let encoded = encodeParams(expectedTypes, params, this._encoder);
    ...
    async #rustyBatch(queries, options) {
        ...
        for (let i = 0; i < queries.length; i++) {
            ...
            if (params) {
                params = encodeParams(types, params, this._encoder);
            }
