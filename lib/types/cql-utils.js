...
function encodeTuple(value, type) {
    let res = [];
    // TODO:
    // Add proper type guessing tuples
    let newTypes = [];
 ...
 * @param {Object} value
 * @param {rust.ComplexType} type
 * @returns {Array<rust.ComplexType|Array<Array<String, any>>>} Returns tuple: [rust.ComplexType, Array<any>]
 */
function encodeUdt(value, type) {
    ...
    return [rust.ComplexType.remapUdtSupportType(type, newTypes), res];
}
