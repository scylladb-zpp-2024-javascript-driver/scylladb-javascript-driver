...
const {
  ...
  getColumnsMetadata,
} = require("./results-wrapper");

const asyncIteratorSymbol = Symbol.asyncIterator || "@@asyncIterator";

/** @module types */

// This is the old constructor definition
// Although it is exposed to the user and in documentation,
// do we really want to support it? The (normal) user shouldn't create it's own ResultSet...
// /**
...
function ResultSet(result) {
   ...
   */
  this.rows = getRowsFromResultsWrapper(result);
   ...
   * @default null
   */
  this.columns = getColumnsMetadata(result);
   ...
   */
  this.info = {
    queriedHost: undefined, // Is supported by rust driver?
    triedHosts: undefined, // Is supported by rust driver?
    speculativeExecutions: undefined, // Is supported by rust driver?
    achievedConsistency: undefined, // Is supported by rust driver?
    traceId: result.getTraceId(),
    warnings: result.getWarnings(),
    customPayload: null, // supported by rust driver?
    isSchemaInAgreement: false, // Is supported by rust driver?
  };
...
ResultSet.prototype.getPageState = function () {
  ...
  // Do we want to keep backward-compatibility things for js-driver?
