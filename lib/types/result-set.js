...
class ResultSet {
    // Old definition of the Result set constructor
    // /**
    //  * @param {Object} result
    //  * @param {String} host
    ...
    constructor(
        ...
        if (!(result instanceof rust.QueryResultWrapper)) {
            ...
            if (result.flags) {
                this.info.traceId = result.flags.traceId;
                this.info.warnings = result.flags.warnings;
                this.info.customPayload = result.flags.customPayload;
            }
         ...
         */
        this.rows = resultsWrapper.getRowsFromResultsWrapper(result, options);
