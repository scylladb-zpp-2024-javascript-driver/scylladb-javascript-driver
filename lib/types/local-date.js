...
/**
 * Maximum number of days from 01.01.1970 served by the class.
 * @const
 */
const maxDay = 2147483647;

/**
 * Minimum number of days from 01.01.1970 served by the class.
 * @const
 */
...
class LocalDate {
     ...
     * @readonly
     * @deprecated The new member value returns always, regardless of the date.
     * @type {Number}
     */
    get _value() {
