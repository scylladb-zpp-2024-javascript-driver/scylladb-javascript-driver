...
class LocalDate {
    ...
    constructor(year, month, day) {
        ...
        if (
            ...
            // it will throw an error if the values are wrong. TODO: add tests for this.
            this.#internal = rust.LocalDateWrapper.new(day, month, year);
            if (!this.#internal.inDate) {
            ...
            this.#internal = rust.LocalDateWrapper.newDay(year);
        } else {
            throw new Error("You must provide a valid year, month and day");
        }
    }
     ...
     */
    get year() {
        return this.#internal.inDate ? this.#internal.year : NaN;
    }
     ...
     */
    get month() {
        return this.#internal.inDate ? this.#internal.month : NaN;
    }
     ...
     */
    get day() {
        return this.#internal.inDate ? this.#internal.day : NaN;
    }
     ...
     */
    get _value() {
        return this.#internal.inDate ? null : this.#internal.value;
    }
    ...
    set valueSinceEpoch(_) {
        throw new SyntaxError("LocalDate valueSinceEpoch is read-only");
    }
     ...
     */
    get date() {
        return new Date(this.#internal.value * millisecondsPerDay);
    }
     ...
     */
    compare(other) {
        if (this.valueSinceEpoch == other.valueSinceEpoch) {
            return 0;
        } else if (this.valueSinceEpoch > other.valueSinceEpoch) {
            return 1;
        }
        return -1;
    }
    ...
    toBuffer() {
        ...
        const value = this.#internal.value + dateCenter;
    ...
    /**
     * Get LocalDate from rust object. Not intended to be exposed in the API
     * @package
